...
const push = function(atom, module = "Elixir_BomberWeb_GamePage", id, payload) {
  liveSocket.getSocket().channels[0].push("port["+module+"]["+id+"]["+atom+"]", payload)
}
const push_self = function(atom, id, payload) {
  liveSocket.getSocket().channels[0].push("port[Elixir_BomberWeb_GamePage]["+id+"]["+atom+"]", payload)
}
const push_self_view = function(atom, payload) {
  liveSocket.getSocket().channels[0].push("port[Elixir_BomberWeb_GamePage][undefined]["+atom+"]", payload)
}
const push_view = function(atom, module = "Elixir_BomberWeb_GamePage", payload) {
